                    ...
                    <div className="mx-auto w-11/12">
                      <div>
                        <div className="md:flex md:justify-between text-main pb-4 md:pb-7">
                          ...
                          {opening.salaryToggle &&
                            opening.lowSalaryRange &&
                            opening.lowSalaryRange && (
                              <p className="text-lg font-gothic mb-2">
                                RM {opening.lowSalaryRange} - RM{" "}
                                {opening.highSalaryRange}
                              </p>
                            )}
                          {!opening.salaryToggle && opening.upToSalary && (
                            <p className="text-lg font-gothic mb-2">
                              {opening.upToSalary}
                            </p>
                          )}
