  ...
  return (
    <section className="flex flex-col justify-center items-center py-20">
      ...
      <div className=" flex justify-center gap-x-6 w-11/12">
        <div>
           <Button title={data?.sectionOne?.callToAction1.buttonText || ""} path={data?.sectionOne?.callToAction1.routes || ""}/>
        </div>
        <div>
         
            <Button title={data?.sectionOne?.callToAction2.buttonText || ""} path={data?.sectionOne?.callToAction2.routes || ""}/>
