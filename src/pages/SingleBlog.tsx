          ...
          <div className="flex flex-col">
            <div className=" w-11/12 lg:w-3/5  -mt-40 mb-12 md:-mt-64 mx-auto bg-white border border-main rounded-t-lg overflow-hidden relative z-10 max-w-[900px]">
              <div className="p-6 pb-28 md:pb-48 pt-16 md:pt-32 sm:px-12 lg:px-24 ">
                ...
                <p className=" text-center text-main  text-[15px] italic ">
                  Written by {postData?.author}
                </p>
                <p className=" text-center text-main  italic text-[15px] mb-4">
                  {formattedDate}
                </p>
                <div className="my-8 flex justify-center items-center gap-12">
                  ...
                  <Link
                    to="https://www.instagram.com/nota.kl/?hl=en"
                    target="_blank"
                  >
                    <img src={InstagramIcon} />
                  </Link>
                  <Link to={`mailto:hello@notakl.com`} target="_blank">
                    <MailOutlined
                      style={{ fontSize: "30px", color: "#595D3C" }}
                    />
                  </Link>
                </div>
                <DescContainer>
            ...
            <div className=" flex flex-col items-center justify-center h-32 text-center bg-white px-12 mx-auto -mt-28 z-30">
              <div className="font-marcellus text-[35px]">
                Share This Article
              </div>
